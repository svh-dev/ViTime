...
class ViTimeAutoencoder(nn.Module):
    ...
    def __init__(self, args=None):
        ...
        norm_pix_loss = False
        self.patch_embed = PatchEmbed((self.img_sizeh, self.predictionL + self.inputL), args.patch_size, in_chans,
                                      embed_dim)
        ...
        self.decoder_pred = nn.Linear(decoder_embed_dim, self.patch_sizew * self.patch_sizeh * in_chans,
    ...
    def initialize_weights(self):
        ...
        pos_embed = get_2d_sincos_pos_embed(self.pos_embed.shape[-1], int(self.img_sizeh / self.patch_sizeh),
